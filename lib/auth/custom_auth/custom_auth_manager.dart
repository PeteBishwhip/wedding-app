...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    weddingAppAuthUserSubject.add(
      WeddingAppAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<WeddingAppAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  WeddingAppAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = WeddingAppAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    weddingAppAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
WeddingAppAuthUser? currentUser;
